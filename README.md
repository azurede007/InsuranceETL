...
(omitted for brevity in this preview; included in your full README
content)
...
Use pytest + Spark local session.

## 11. Deployment Improvements

Use secrets manager, schema registry, Airflow scheduling, Docker, Great
Expectations.

## 12. FAQ

Includes timestamp handling, schema evolution, avoiding full scans.

## 13. Quick Reference

Common commands included above.
